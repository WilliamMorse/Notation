...
var $author$project$Exp$init = function (_v0) {
	...
	return _Utils_Tuple2(zip, $elm$core$Platform$Cmd$none);
};
var $elm$core$Platform$Sub$batch = _Platform_batch;
var $elm$core$Platform$Sub$none = $elm$core$Platform$Sub$batch(_List_Nil);
var $author$project$Exp$subscriptions = function (_v0) {
	return $elm$core$Platform$Sub$none;
};
var $author$project$Exp$Collapsed = {$: 'Collapsed'};
var $author$project$Exp$blankStep = A6($author$project$Exp$Step, 'Operation', 'Equation', 'Notes', 0, false, $author$project$Exp$Standalone);
...
var $author$project$Exp$insertBelow = F2(
	function (step, zip) {
		return A2(
			...
			step,
			$author$project$Exp$upOrRoot(zip));
	});
...
var $author$project$Exp$sendToKatex = function (zip) {
...
var $author$project$Exp$renderAllOpen = function (zip) {
	var _v0 = $turboMaCk$lazy_tree_with_zipper$Lazy$Tree$Zipper$current(zip).process;
	switch (_v0.$) {
		case 'Standalone':
			return $author$project$Exp$sendToKatex(zip);
		case 'Collapsed':
			return $author$project$Exp$sendToKatex(zip);
		default:
			...
			if (!_v1.b) {
				...
				return $elm$core$Platform$Cmd$batch(
					A2(
						...
						A2($elm$core$List$map, $author$project$Exp$renderAllOpen, z)));
			}
	}
};
		...
		switch (msg.$) {
			...
			case 'ToggleProcess':
				...
				switch (_v1.$) {
					case 'Standalone':
						return _Utils_Tuple2(
							$turboMaCk$lazy_tree_with_zipper$Lazy$Tree$Zipper$root(zip),
							$elm$core$Platform$Cmd$none);
					case 'Expanded':
						return _Utils_Tuple2(
							$turboMaCk$lazy_tree_with_zipper$Lazy$Tree$Zipper$root(
			...
			default:
				return _Utils_Tuple2(
					...
					$elm$core$Platform$Cmd$batch(
						A2(
							$elm$core$List$map,
							$author$project$Exp$renderAllOpen,
...
var $author$project$Exp$EditStep = function (a) {
	return {$: 'EditStep', a: a};
};
...
var $author$project$Exp$edges = {bottom: 0, left: 0, right: 0, top: 0};
...
var $author$project$Exp$viewProcessIcon = function (zip) {
				...
				[
					...
					_List_fromArray(
						[
							...
							$mdgriffith$elm_ui$Element$text(
								$turboMaCk$lazy_tree_with_zipper$Lazy$Tree$Zipper$current(zip).operation)),
							$author$project$Exp$viewProcessIcon(zip)
						]))
				])
			]));
};
var $author$project$Exp$viewProcess = function (zip) {
	return _Utils_eq(
		$turboMaCk$lazy_tree_with_zipper$Lazy$Tree$Zipper$current(zip).process,
		$author$project$Exp$Expanded) ? A2(
		$elm$core$List$map,
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_Utils_update(
					$author$project$Exp$edges,
					{left: 10}))
			]),
		$elm$core$List$concat(
			_List_fromArray(
				[
					$author$project$Exp$viewOperation(zip),
					_List_fromArray(
					[
						$author$project$Exp$viewKatexEquation(zip)
					]),
					_List_fromArray(
					[
						$author$project$Exp$viewNote(zip)
					])
				])));
};
...
var $author$project$Exp$main = $elm$browser$Browser$element(
	{init: $author$project$Exp$init, subscriptions: $author$project$Exp$subscriptions, update: $author$project$Exp$update, view: $author$project$Exp$view});
_Platform_export({'Exp':{'init':$author$project$Exp$main(
