...
var $author$project$Main$Standalone = {$: 'Standalone'};
...
var $author$project$Main$init = function (_v0) {
	var startingStep = $turboMaCk$lazy_tree_with_zipper$Lazy$Tree$singleton(
		A6($author$project$Main$Step, 'Starting Operation', 'y=mx+b', 'notesnotesnotes', 0, false, $author$project$Main$Standalone));
	var root = $turboMaCk$lazy_tree_with_zipper$Lazy$Tree$singleton(
		A6($author$project$Main$Step, 'On', 'Turtles', 'Turtles All the way', -1, false, $author$project$Main$Expanded));
...
var $author$project$Main$blankStep = A6($author$project$Main$Step, 'Operation', 'Equation', 'Notes', 0, false, $author$project$Main$Standalone);
...
var $turboMaCk$lazy_tree_with_zipper$Lazy$LList$sortBy = function (predicate) {
	return $turboMaCk$lazy_tree_with_zipper$Lazy$map(
		$elm$core$List$sortBy(predicate));
};
var $turboMaCk$lazy_tree_with_zipper$Lazy$Tree$sortBy = F2(
	function (predicate, _v0) {
		...
		return A2(
			...
			a,
			A2(
				$turboMaCk$lazy_tree_with_zipper$Lazy$LList$map,
				$turboMaCk$lazy_tree_with_zipper$Lazy$Tree$sortBy(predicate),
				A2(
					$turboMaCk$lazy_tree_with_zipper$Lazy$LList$sortBy,
					A2($elm$core$Basics$composeL, predicate, $turboMaCk$lazy_tree_with_zipper$Lazy$Tree$item),
					f)));
	});
var $turboMaCk$lazy_tree_with_zipper$Lazy$Tree$Zipper$update = F2(
	function (f, _v0) {
		var t = _v0.a;
		var bs = _v0.b;
		return A2(
...
var $author$project$Main$nest = F2(
	function (step, zip) {
		return A2(
...
var $author$project$Main$upOrRoot = function (z) {
...
var $author$project$Main$insertBelow = F2(
	function (step, zip) {
		return A2(
			$author$project$Main$nest,
			step,
			$author$project$Main$upOrRoot(zip));
	});
...
var $turboMaCk$lazy_tree_with_zipper$Lazy$Tree$Zipper$breadcrumbsMap = function (predicate) {
	return $elm$core$List$map(
		function (_v0) {
			var left = _v0.a.left;
			var parent = _v0.a.parent;
			var right = _v0.a.right;
...
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'EditStep':
				var zip = msg.a;
				return $turboMaCk$lazy_tree_with_zipper$Lazy$Tree$Zipper$root(
					A2(
			...
			case 'ConsecutiveStep':
				...
				return $turboMaCk$lazy_tree_with_zipper$Lazy$Tree$Zipper$root(
					A2(
						$author$project$Main$insertBelow,
						_Utils_update(
							$author$project$Main$blankStep,
							{
					...
					A2(
						...
						A2(
							...
							function (s) {
								return _Utils_update(
									s,
									{process: $author$project$Main$Expanded});
							},
							A2(
								$turboMaCk$lazy_tree_with_zipper$Lazy$Tree$Zipper$map,
								function (s) {
						...
						return $turboMaCk$lazy_tree_with_zipper$Lazy$Tree$Zipper$root(
							A2(
								...
								function (a) {
									return _Utils_update(
										a,
										{process: $author$project$Main$Collapsed});
								},
								zip));
					default:
						return $turboMaCk$lazy_tree_with_zipper$Lazy$Tree$Zipper$root(
...
var $author$project$Main$EditStep = function (a) {
	return {$: 'EditStep', a: a};
};
var $author$project$Main$ToggleProcess = function (a) {
			...
			return A2(
				...
				A2(
					...
					$turboMaCk$lazy_tree_with_zipper$Lazy$Tree$Zipper$Breadcrumb(
						{
							left: left,
							parent: $turboMaCk$lazy_tree_with_zipper$Lazy$Tree$item(tree),
							right: right
						}),
					zipperBreadcrumbs));
		},
...
var $author$project$Main$labelEquation = function (zip) {
	return A2(
		$elm$core$String$join,
		'.',
		A2(
...
var $author$project$Main$viewKatexEquation = function (zip) {
	return A2(
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$Attributes$id(
							$author$project$Main$labelEquation(zip)))
					]),
...
var $author$project$Main$viewNote = function (zip) {
	return $mdgriffith$elm_ui$Element$text(
		$turboMaCk$lazy_tree_with_zipper$Lazy$Tree$Zipper$current(zip).note);
};
var $author$project$Main$NewProcessStep = function (a) {
	return {$: 'NewProcessStep', a: a};
};
var $author$project$Main$viewProcessIcon = function (zip) {
	var step = $turboMaCk$lazy_tree_with_zipper$Lazy$Tree$Zipper$current(zip);
	var a = $mdgriffith$elm_ui$Element$Font$family(
		_List_fromArray(
			[$mdgriffith$elm_ui$Element$Font$monospace]));
	var _v0 = step.process;
	switch (_v0.$) {
		case 'Standalone':
			return A2(
					...
					[a]),
				{
					...
					onPress: $elm$core$Maybe$Just(
						$author$project$Main$NewProcessStep(zip))
				});
		case 'Expanded':
			return A2(
				$mdgriffith$elm_ui$Element$Input$button,
		...
		default:
			return A2(
					...
					[a]),
				{
					label: $mdgriffith$elm_ui$Element$text('[+]'),
					onPress: $elm$core$Maybe$Just(
						$author$project$Main$ToggleProcess(zip))
				});
	}
};
var $author$project$Main$viewOperation = function (zip) {
	return $elm$core$List$concat(
		_List_fromArray(
			[
				_Utils_eq(
				$turboMaCk$lazy_tree_with_zipper$Lazy$Tree$Zipper$current(zip).process,
				$author$project$Main$Expanded) ? A2(
				$elm$core$List$cons,
				A2(
					$mdgriffith$elm_ui$Element$row,
					_List_fromArray(
				...
				$author$project$Main$viewProcess(zip)) : _List_Nil,
				_List_fromArray(
				[
					A2(
					$mdgriffith$elm_ui$Element$row,
						...
						[
							...
							_List_fromArray(
								[
									...
									$author$project$Main$EditStep(zip))
								]),
							$mdgriffith$elm_ui$Element$text(
								$turboMaCk$lazy_tree_with_zipper$Lazy$Tree$Zipper$current(zip).operation)),
							$author$project$Main$viewProcessIcon(zip)
						]))
				])
			]));
};
var $author$project$Main$viewProcess = function (zip) {
	return _Utils_eq(
		$turboMaCk$lazy_tree_with_zipper$Lazy$Tree$Zipper$current(zip).process,
		$author$project$Main$Expanded) ? A2(
		$elm$core$List$map,
...
var $author$project$Main$viewStep = function (zip) {
	var step = $turboMaCk$lazy_tree_with_zipper$Lazy$Tree$Zipper$current(zip);
	return A2(
		...
		$elm$core$List$concat(
			_List_fromArray(
				[
					$author$project$Main$viewOperation(zip),
					_List_fromArray(
					[
						$author$project$Main$viewKatexEquation(zip)
					]),
					_List_fromArray(
					[
						$author$project$Main$viewNote(zip)
					])
				])));
};
var $author$project$Main$view = function (model) {
	return A2(
		...
		A2(
			...
			$author$project$Main$viewProcess(model)));
};
var $author$project$Main$main = $elm$browser$Browser$element(
	{
		...
		update: F2(
			function (mess, mod) {
				return _Utils_Tuple2(
					A2($author$project$Main$update, mess, mod),
