	...
	function (v) {
		return {
			entries: _elm_lang$core$Native_List.toArray(v.entries).map(
				function (v) {
					return {description: v.description, do_show: v.do_show, editing: v.editing, id: v.id};
				}),
			field: v.field,
			uid: v.uid,
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				A2(
					...
					A2(
						_elm_lang$core$Basics_ops['++'],
						_elm_lang$core$Basics$toString(entriesShown),
						')')))
			]));
};
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						{ctor: '_Tuple2', _0: 'show', _1: todo.do_show},
...
var _evancz$elm_todomvc$Todo$viewEntries = F2(
	function (visibility, entries) {
		...
		var isVisible = function (todo) {
			...
			switch (_p6) {
				case 'Shown':
					return _elm_lang$core$Basics$not(todo.do_show);
				case 'Primary':
					return todo.do_show;
				default:
					return true;
						...
						_elm_lang$core$Json_Decode$list(
							A2(
								...
								function (description) {
									return A2(
										_elm_lang$core$Json_Decode$andThen,
										A2(_elm_lang$core$Json_Decode_ops[':='], 'do_show', _elm_lang$core$Json_Decode$bool),
										function (do_show) {
											return A2(
												_elm_lang$core$Json_Decode$andThen,
													...
													return A2(
														...
														function (id) {
															return _elm_lang$core$Json_Decode$succeed(
																{description: description, do_show: do_show, editing: editing, id: id});
														});
												});
										});
								}))),
