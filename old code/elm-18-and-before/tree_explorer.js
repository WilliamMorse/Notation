...
var _user$project$Tree_Tree$display = F2(
	function (name, value) {
		return A2(
...
var _user$project$Tree_Tree$notEmptyList = function (l) {
	var _p0 = l;
	if (_p0.ctor === '[]') {
		return false;
	} else {
...
var _user$project$Tree_Tree$findSubTrees = F2(
	function (x, tree) {
		var lookElsewhere = F2(
			function (y, cl) {
				return _elm_lang$core$List$head(
					A2(
						_elm_lang$core$List$filter,
						_user$project$Tree_Tree$notEmptyList,
						A2(
							_elm_lang$core$List$map,
							_user$project$Tree_Tree$findSubTrees(x),
							cl)));
			});
		var findOtherNodes = F2(
			function (y, cl) {
				var some = A2(lookElsewhere, y, cl);
				var _p1 = some;
				if (_p1.ctor === 'Just') {
					return _p1._0;
				} else {
		...
		if (_p2.ctor === 'Zip') {
			...
			return _elm_lang$core$Native_Utils.eq(x.id, _p3.id) ? {
				...
				_0: tree,
				_1: {ctor: '[]'}
			} : A2(findOtherNodes, _p3, _p2._1);
		}
	});
var _user$project$Tree_Tree$max_in_list = F2(
	function (v, l) {
		max_in_list:
		while (true) {
			var _p4 = l;
			if (_p4.ctor === '[]') {
				...
				var _p6 = _p4._1;
				var _p5 = _p4._0;
				if (_elm_lang$core$Native_Utils.cmp(_p5, v) > 0) {
					var _v4 = _p5,
						_v5 = _p6;
					v = _v4;
					l = _v5;
					continue max_in_list;
				} else {
					var _v6 = v,
						_v7 = _p6;
					v = _v6;
...
var _user$project$Tree_Tree$depth = function (tree) {
	var _p7 = tree;
	if (_p7.ctor === 'Zip') {
		return 0;
	} else {
		return 1 + A2(
			_user$project$Tree_Tree$max_in_list,
			0,
			A2(_elm_lang$core$List$map, _user$project$Tree_Tree$depth, _p7._1));
	}
};
var _user$project$Tree_Tree$hasParentAux = F2(
	function (node, tree) {
		var _p8 = tree;
		if (_p8.ctor === 'Zip') {
			return false;
		} else {
			return _elm_lang$core$Native_Utils.eq(_p8._0.id, node.id) ? true : A2(
				_elm_lang$core$List$member,
				true,
				A2(
					_elm_lang$core$List$map,
					_user$project$Tree_Tree$hasParentAux(node),
					_p8._1));
		}
	});
var _user$project$Tree_Tree$hasParentIn = F2(
	function (node, tree) {
		var _p9 = tree;
		if (_p9.ctor === 'Zip') {
			return false;
		} else {
			return _elm_lang$core$Native_Utils.eq(_p9._0.id, node.id) ? false : A2(
				_elm_lang$core$List$member,
				true,
				A2(
					_elm_lang$core$List$map,
...
var _user$project$Tree_Tree$newStep2 = F2(
	function (new_id, equa) {
		return {id: new_id, eq: equa};
	});
var _user$project$Tree_Tree$newStep = function (new_id) {
	return {id: new_id, eq: ''};
};
var _user$project$Tree_Tree$findParentNode = F3(
	function (p, x, tree) {
		var lookElsewhere = F3(
			function (p, y, cl) {
				return _elm_lang$core$List$head(
					A2(
						_elm_lang$core$List$filter,
						function (a) {
							return _elm_lang$core$Native_Utils.cmp(a.id, 0) > 0;
						},
						A2(
							_elm_lang$core$List$map,
							A2(_user$project$Tree_Tree$findParentNode, p, x),
							cl)));
			});
		var findOtherNodes = F3(
			function (p, y, cl) {
				var some = A3(lookElsewhere, p, y, cl);
				var _p10 = some;
				if (_p10.ctor === 'Just') {
					return _p10._0;
				} else {
					return _user$project$Tree_Tree$newStep(0);
				}
			});
		var _p11 = tree;
		if (_p11.ctor === 'Zip') {
			...
			var _p12 = _p11._0;
			return _elm_lang$core$Native_Utils.eq(x.id, _p12.id) ? p : A3(findOtherNodes, _p12, _p12, _p11._1);
		}
	});
var _user$project$Tree_Tree$Step = F2(
	function (a, b) {
		return {id: a, eq: b};
	});
var _user$project$Tree_Tree$After = {ctor: 'After'};
var _user$project$Tree_Tree$Before = {ctor: 'Before'};
var _user$project$Tree_Tree$Node = F2(
	function (a, b) {
		return {ctor: 'Node', _0: a, _1: b};
	});
var _user$project$Tree_Tree$leaf = function (v) {
	return A2(
		_user$project$Tree_Tree$Node,
		v,
		{ctor: '[]'});
};
var _user$project$Tree_Tree$find = F2(
	function (id, tree) {
		var found = _elm_lang$core$List$head(
			A2(
				_user$project$Tree_Tree$findSubTrees,
				_user$project$Tree_Tree$newStep(id),
				tree));
		var found_tree = function () {
			var _p13 = found;
			if (_p13.ctor === 'Nothing') {
				return _user$project$Tree_Tree$leaf(
					_user$project$Tree_Tree$newStep(0));
			} else {
				return _p13._0;
			}
		}();
...
var _user$project$Tree_Tree$insert = F2(
	function (x, tree) {
		var _p15 = tree;
		if (_p15.ctor === 'Zip') {
			return _user$project$Tree_Tree$leaf(x);
		} else {
			var _p17 = _p15._0;
			var _p16 = _p15._1;
			return (_elm_lang$core$Native_Utils.cmp(x.id, _p17.id) < 1) ? A2(
				_user$project$Tree_Tree$Node,
				_p17,
				A2(
					_elm_lang$core$List$append,
					{
						ctor: '::',
						_0: _user$project$Tree_Tree$leaf(x),
						_1: {ctor: '[]'}
					},
					_p16)) : A2(
				_user$project$Tree_Tree$Node,
...
var _user$project$Tree_Tree$Zip = {ctor: 'Zip'};
var _user$project$Tree_Tree$empty = _user$project$Tree_Tree$Zip;
var _user$project$Tree_Tree$fromList = function (xs) {
	return A3(_elm_lang$core$List$foldl, _user$project$Tree_Tree$insert, _user$project$Tree_Tree$empty, xs);
};
var _user$project$Tree_Tree$niceTree = _user$project$Tree_Tree$fromList(
	{
		ctor: '::',
		_0: _user$project$Tree_Tree$newStep(5),
		_1: {
			ctor: '::',
			_0: _user$project$Tree_Tree$newStep(2),
			_1: {
				ctor: '::',
				_0: _user$project$Tree_Tree$newStep(1),
				_1: {
					ctor: '::',
					_0: _user$project$Tree_Tree$newStep(4),
					_1: {
						ctor: '::',
						_0: _user$project$Tree_Tree$newStep(3),
						_1: {ctor: '[]'}
					}
				}
			}
...
var _user$project$Tree_Tree$insertUnder = F4(
	function ($this, x, inPlace, tree) {
		var _p18 = tree;
		if (_p18.ctor === 'Zip') {
			return _user$project$Tree_Tree$Zip;
		} else {
			var _p21 = _p18._0;
			var _p20 = _p18._1;
			if (_elm_lang$core$Native_Utils.eq(_p21.id, $this.id)) {
				var _p19 = inPlace;
				if (_p19.ctor === 'After') {
					return A2(
						_user$project$Tree_Tree$Node,
				...
				return A2(
					...
					A2(
						_elm_lang$core$List$map,
						A3(_user$project$Tree_Tree$insertUnder, $this, x, inPlace),
						_p20));
			}
		}
	});
var _user$project$Tree_Tree$niceTree2 = A4(
	_user$project$Tree_Tree$insertUnder,
	_user$project$Tree_Tree$newStep(5),
	_user$project$Tree_Tree$newStep(20),
	_user$project$Tree_Tree$Before,
	_user$project$Tree_Tree$niceTree);
var _user$project$Tree_Tree$niceTree3 = A4(
	_user$project$Tree_Tree$insertUnder,
	_user$project$Tree_Tree$newStep(20),
	_user$project$Tree_Tree$newStep(22),
	_user$project$Tree_Tree$After,
	_user$project$Tree_Tree$niceTree2);
var _user$project$Tree_Tree$niceTree4 = A4(
	_user$project$Tree_Tree$insertUnder,
	_user$project$Tree_Tree$newStep(8),
	_user$project$Tree_Tree$newStep(90),
	_user$project$Tree_Tree$After,
	A4(
		_user$project$Tree_Tree$insertUnder,
		_user$project$Tree_Tree$newStep(20),
		_user$project$Tree_Tree$newStep(8),
		_user$project$Tree_Tree$Before,
		_user$project$Tree_Tree$niceTree3));
var _user$project$Tree_Tree$map = F2(
	function (f, tree) {
		var _p22 = tree;
		if (_p22.ctor === 'Zip') {
			return _user$project$Tree_Tree$Zip;
			...
			return A2(
				...
				A2(
					_elm_lang$core$List$map,
					_user$project$Tree_Tree$map(f),
					_p22._1));
		}
	});
var _user$project$Tree_Tree$main = _elm_lang$virtual_dom$Native_VirtualDom.staticProgram(
	A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		{
			ctor: '::',
			_0: A2(_user$project$Tree_Tree$display, 'niceTree', _user$project$Tree_Tree$niceTree),
			_1: {
				ctor: '::',
				_0: A2(_user$project$Tree_Tree$display, 'niceTree2', _user$project$Tree_Tree$niceTree2),
				_1: {
					ctor: '::',
					_0: A2(_user$project$Tree_Tree$display, 'niceTree3', _user$project$Tree_Tree$niceTree3),
					_1: {
						ctor: '::',
						_0: A2(_user$project$Tree_Tree$display, 'niceTree4', _user$project$Tree_Tree$niceTree4),
						_1: {
							ctor: '::',
							_0: A2(
								_user$project$Tree_Tree$display,
								'depth niceTree',
								_user$project$Tree_Tree$depth(_user$project$Tree_Tree$niceTree)),
							_1: {
								ctor: '::',
								_0: A2(
									_user$project$Tree_Tree$display,
									'depth niceTree2',
									_user$project$Tree_Tree$depth(_user$project$Tree_Tree$niceTree2)),
								_1: {
									ctor: '::',
									_0: A2(
										_user$project$Tree_Tree$display,
										'depth niceTree3',
										_user$project$Tree_Tree$depth(_user$project$Tree_Tree$niceTree3)),
									_1: {
										ctor: '::',
										_0: A2(
											_user$project$Tree_Tree$display,
											'depth niceTree4',
											_user$project$Tree_Tree$depth(_user$project$Tree_Tree$niceTree4)),
										_1: {
											ctor: '::',
											_0: A2(
												_user$project$Tree_Tree$display,
											...
											_1: {
												...
												_0: A2(
													_user$project$Tree_Tree$display,
													'insertUnder 5 66 Before ',
													A4(
														_user$project$Tree_Tree$insertUnder,
														_user$project$Tree_Tree$newStep(5),
														_user$project$Tree_Tree$newStep(66),
														_user$project$Tree_Tree$Before,
														_user$project$Tree_Tree$niceTree)),
												_1: {
													ctor: '::',
													...
													_1: {
														...
														_1: {
															...
															_0: A2(
																_user$project$Tree_Tree$display,
																'findSubTrees 20 niceTree4',
																A2(
																	_user$project$Tree_Tree$findSubTrees,
																	_user$project$Tree_Tree$newStep(20),
																	_user$project$Tree_Tree$niceTree4)),
															_1: {
																ctor: '::',
																_0: A2(
																	_user$project$Tree_Tree$display,
																	'findSubTrees 22 niceTree4',
																	A2(
																		_user$project$Tree_Tree$findSubTrees,
																		_user$project$Tree_Tree$newStep(22),
																		_user$project$Tree_Tree$niceTree4)),
																_1: {
																	...
																	_1: {
																		...
																		_0: A2(
																			_user$project$Tree_Tree$display,
																			'findSubTrees 88 niceTree4',
																			A2(
																				_user$project$Tree_Tree$findSubTrees,
																				_user$project$Tree_Tree$newStep(88),
																				_user$project$Tree_Tree$niceTree4)),
																		_1: {
																			ctor: '::',
																			_0: A2(
																				_user$project$Tree_Tree$display,
																				'findSubTrees 83 niceTree4',
																				A2(
																					_user$project$Tree_Tree$findSubTrees,
																					_user$project$Tree_Tree$newStep(83),
																					_user$project$Tree_Tree$niceTree4)),
																			_1: {
																				ctor: '::',
																				_0: A2(
																				...
																				_1: {
																						...
																						A2(
																							...
																							_user$project$Tree_Tree$notEmptyList,
																							{
																								...
																								_1: {
																									...
																									_0: {
																										ctor: '::',
																										_0: _user$project$Tree_Tree$niceTree,
																										_1: {ctor: '[]'}
																									},
																									_1: {ctor: '[]'}
																								}
																					...
																					_1: {
																						...
																						_0: A2(
																							_user$project$Tree_Tree$display,
																							'hasParentIn 5 niceTree  ',
																							A2(
																								_user$project$Tree_Tree$hasParentIn,
																								_user$project$Tree_Tree$newStep(5),
																								_user$project$Tree_Tree$niceTree)),
																						_1: {
																							ctor: '::',
																							_0: A2(
																								_user$project$Tree_Tree$display,
																								'hasParentIn 3 niceTree  ',
																								A2(
																									_user$project$Tree_Tree$hasParentIn,
																									_user$project$Tree_Tree$newStep(3),
																									_user$project$Tree_Tree$niceTree)),
																							_1: {
																								ctor: '::',
																								_0: A2(
																									_user$project$Tree_Tree$display,
																									'hasParentIn 5 niceTree4  ',
																									A2(
																										_user$project$Tree_Tree$hasParentIn,
																										_user$project$Tree_Tree$newStep(5),
																										_user$project$Tree_Tree$niceTree4)),
																										...
																										_1: {
																											...
																											_1: {
																												...
																												_1: {
																													...
																													_0: A2(
																														_user$project$Tree_Tree$display,
																														'findParentNode 0 8 niceTree4  ',
																														A3(
																															_user$project$Tree_Tree$findParentNode,
																															_user$project$Tree_Tree$newStep(0),
																															_user$project$Tree_Tree$newStep(8),
																															_user$project$Tree_Tree$niceTree4)),
																													_1: {
...
var _user$project$Port_Port$renderEquation = _elm_lang$core$Native_Platform.outgoingPort(
	'renderEquation',
	function (v) {
		return v;
	});

var _user$project$Main$displayTree = F2(
	function (name, value) {
		return A2(
			_elm_lang$html$Html$div,
			{
				...
				_0: _elm_lang$html$Html_Attributes$style(
					{
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 'margin-top', _1: '22px'},
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			},
...
var _user$project$Main$enterAndGo = F3(
	function (model, keyboardModel, next_id) {
		var new_tree = A4(
			_user$project$Tree_Tree$insertUnder,
			model.current_equation,
			A2(_user$project$Tree_Tree$newStep2, next_id, model.laTeX),
			_user$project$Tree_Tree$After,
			model.equation_edits_tree);
		var new_current_eq = A2(_user$project$Tree_Tree$find, next_id, new_tree);
		return _elm_lang$core$Native_Utils.update(
			model,
			{keyboardModel: keyboardModel, equation_edits_tree: new_tree, current_equation: new_current_eq, laTeX: new_current_eq.eq, new_node: next_id});
	});
var _user$project$Main$goBackUp = function (model) {
	var new_eq = A3(
		_user$project$Tree_Tree$findParentNode,
		_user$project$Tree_Tree$newStep(0),
		model.current_equation,
	...
	return _elm_lang$core$Native_Utils.update(
		model,
		{current_equation: new_eq, laTeX: new_eq.eq});
};
var _user$project$Main$goNextDn = F2(
	function (to_id, model) {
		var new_eq = A2(_user$project$Tree_Tree$find, to_id, model.equation_edits_tree);
		return _elm_lang$core$Native_Utils.update(
			model,
			{current_equation: new_eq, laTeX: new_eq.eq});
	});
var _user$project$Main$last_child_id = function (cl) {
	var maybe_last = function (cl) {
		return _elm_lang$core$List$head(
			_elm_lang$core$List$reverse(cl));
	};
	var _p0 = maybe_last(cl);
	if (_p0.ctor === 'Just') {
		return _p0._0.id;
	} else {
		return -1;
...
var _user$project$Main$Model = F5(
	function (a, b, c, d, e) {
		return {keyboardModel: a, laTeX: b, equation_edits_tree: c, current_equation: d, new_node: e};
	});
var _user$project$Main$RenderEquation = {ctor: 'RenderEquation'};
var _user$project$Main$KeyboardMsg = function (a) {
	return {ctor: 'KeyboardMsg', _0: a};
};
var _user$project$Main$init = function () {
	var _p1 = _ohanhi$keyboard_extra$Keyboard_Extra$init;
	var keyboardModel = _p1._0;
	var keyboardCmd = _p1._1;
	return {
		ctor: '_Tuple2',
		_0: A5(
			...
			keyboardModel,
			'',
			_user$project$Tree_Tree$fromList(
				{
					ctor: '::',
					_0: _user$project$Tree_Tree$newStep(0),
					_1: {ctor: '[]'}
				}),
			_user$project$Tree_Tree$newStep(0),
			100),
		_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Main$KeyboardMsg, keyboardCmd)
	};
}();
		...
		switch (_p2.ctor) {
			case 'LaTeX':
				return A2(
					...
					{ctor: '[]'});
			case 'KeyboardMsg':
				var next_id = model.new_node + 1;
				var _p3 = A2(_ohanhi$keyboard_extra$Keyboard_Extra$update, _p2._0, model.keyboardModel);
				...
				return shift_enter ? A2(
					...
					{
						ctor: '::',
						_0: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Main$KeyboardMsg, keyboardCmd),
						_1: {ctor: '[]'}
					}) : (ctl_back ? A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
			...
			case 'GoDown':
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					A2(_user$project$Main$goNextDn, _p2._0, model),
					{ctor: '[]'});
			default:
				return {
					ctor: '_Tuple2',
...
var _user$project$Main$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: A2(_elm_lang$core$Platform_Sub$map, _user$project$Main$KeyboardMsg, _ohanhi$keyboard_extra$Keyboard_Extra$subscriptions),
			_1: {ctor: '[]'}
		});
};
...
var _user$project$Main$makeChildButton = function (tree) {
	var _p4 = tree;
	if (_p4.ctor === 'Zip') {
		return A2(
				...
				_0: A2(
					_elm_lang$html$Html$button,
					{
						...
						_0: _elm_lang$html$Html_Events$onClick(
							_user$project$Main$GoDown(_p5.id)),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('go ahead to:'),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
...
var _user$project$Main$childNav = F2(
	function (node_id, tree) {
		var st = function (some_tree) {
			var _p6 = some_tree;
			if (_p6.ctor === 'Just') {
				return _p6._0;
			} else {
		...
		var sub_tree_list = F2(
			function (n, t) {
				return A2(_user$project$Tree_Tree$findSubTrees, n, t);
			});
		var find_node = F2(
			function (n, t) {
				return st(
					_elm_lang$core$List$head(
						A2(sub_tree_list, n, t)));
			});
		var _p7 = A2(find_node, node_id, tree);
		if (_p7.ctor === 'Zip') {
			return A2(
				_elm_lang$html$Html$div,
				{ctor: '[]'},
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('this node has no children at this time'),
					_1: {ctor: '[]'}
				});
		} else {
			return A2(
				_elm_lang$html$Html$div,
				{ctor: '[]'},
				A2(_elm_lang$core$List$map, _user$project$Main$makeChildButton, _p7._1));
		}
	});
var _user$project$Main$GoUp = {ctor: 'GoUp'};
var _user$project$Main$LaTeX = function (a) {
	return {ctor: 'LaTeX', _0: a};
};
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				_elm_lang$html$Html$input,
				{
					...
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onInput(_user$project$Main$LaTeX),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$value(model.laTeX),
							_1: {ctor: '[]'}
						}
					}
				},
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$id('math-jax-out'),
						_1: {ctor: '[]'}
					},
					{ctor: '[]'}),
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onClick(_user$project$Main$RenderEquation),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Render Equation Now'),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: A2(_user$project$Tree_Tree$hasParentIn, model.current_equation, model.equation_edits_tree) ? A2(
									_elm_lang$html$Html$button,
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Events$onClick(_user$project$Main$GoUp),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('you\'re at the very beginning'),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
									_0: A2(
										...
										{
											ctor: '::',
											_0: A2(_user$project$Main$childNav, model.current_equation, model.equation_edits_tree),
											_1: {ctor: '[]'}
										}),
									_1: {
										ctor: '::',
										_0: A2(_user$project$Main$displayTree, 'equation edits tree ', model.equation_edits_tree),
										_1: {ctor: '[]'}
									}
								}
							}),
